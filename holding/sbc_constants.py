...
def draw_chakra(d, zodiac=False, langfile=mixed, themefile=themepath + theme):
    ...
    nakshatraeq, nakshatra, adityas, tithi, vara, zsigns = sbc_names.init_sbc_names(
        langfile
    )
    ...
    for n in range(12):
        ...
        d.append(
            draw.Text(
                tithi[0], font_size=5, x=coords[4][3][0] + 9, y=coords[4][3][1] + 5
            )
        )
        d.append(
            draw.Text(
                vara[0], font_size=5, x=coords[4][3][0] + 7, y=coords[4][3][1] + 20
            )
        )
        d.append(
            draw.Text(
                vara[2], font_size=5, x=coords[4][3][0] + 3, y=coords[4][3][1] + 25
            )
        )
        # bhadra, somavara, budhavara
        d.append(
            draw.Text(
                tithi[1], font_size=5, x=coords[5][4][0] + 8, y=coords[5][4][1] + 5
            )
        )
        d.append(
            draw.Text(
                vara[1], font_size=5, x=coords[5][4][0] + 6, y=coords[5][4][1] + 20
            )
        )
        d.append(
            draw.Text(
                vara[3], font_size=5, x=coords[5][4][0] + 5, y=coords[5][4][1] + 25
            )
        )
        # jaya, guruvara
        d.append(
            draw.Text(
                tithi[2], font_size=5, x=coords[4][5][0] + 11, y=coords[4][5][1] + 5
            )
        )
        d.append(
            draw.Text(
                vara[4], font_size=5, x=coords[4][5][0] + 7, y=coords[4][5][1] + 25
            )
        )
        # rikta, shukravara
        d.append(
            draw.Text(
                tithi[3], font_size=5, x=coords[3][4][0] + 11, y=coords[3][4][1] + 5
            )
        )
        d.append(
            draw.Text(
                vara[5], font_size=5, x=coords[3][4][0] + 6, y=coords[3][4][1] + 25
            )
        )
        # purna, shanivara
        d.append(
