...
One star identifier per line. Blank lines and `#` comments are skipped: (actually, I
believe blank lines cause swisseph to say sefstars.txt is broken...would be nice to fix
that)
